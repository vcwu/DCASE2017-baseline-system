...
#SBATCH -o ../results/C_1_08.out # output file name, in case your program has anything to output (like print, etc)
...
python ../applications/task1.py -m challenge -p ../configs/C_0_08.yaml >> ../results/C_1_08.log 
