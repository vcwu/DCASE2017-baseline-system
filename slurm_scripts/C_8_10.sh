...
#SBATCH -o ../results/C_8_10.out # output file name, in case your program has anything to output (like print, etc)
...
python ../applications/task1.py  -p ../configs/C_8_10.yaml >> ../results/C_8_10.log 
