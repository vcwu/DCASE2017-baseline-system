...
#SBATCH -o ../results/baseline_dev.out # output file name, in case your program has anything to output (like print, etc)
#SBATCH -t 6:00:00 # Amount of time
#SBATCH --gres=gpu:2 # No. of GPU cores you wanna use. Usually 2-3
#SBATCH --mem 14000 

source activate dlnn_gpu 
python ../applications/task1.py  -s dcase2017_gpu -m dev >> ../results/baseline_dev.log
