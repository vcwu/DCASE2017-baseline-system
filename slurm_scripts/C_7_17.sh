...
#SBATCH -o ../results/C_7_17.out # output file name, in case your program has anything to output (like print, etc)
...
python ../applications/task1.py  -p ../configs/C_7_17.yaml >> ../results/C_7_17.log 
