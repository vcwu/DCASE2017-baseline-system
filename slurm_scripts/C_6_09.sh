...
#SBATCH -o ../results/C_6_09.out # output file name, in case your program has anything to output (like print, etc)
...
python ../applications/task1.py  -p ../configs/C_6_09.yaml >> ../results/C_6_09.log 
