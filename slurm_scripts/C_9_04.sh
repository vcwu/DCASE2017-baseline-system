...
#SBATCH -o ../results/C_9_04.out # output file name, in case your program has anything to output (like print, etc)
...
python ../applications/task1.py  -p ../configs/C_9_04.yaml >> ../results/C_9_04.log 
