...
#SBATCH -o ../results/C_8_08.out # output file name, in case your program has anything to output (like print, etc)
#SBATCH -t 12:00:00 # Amount of time
...
python ../applications/task1.py  -p ../configs/C_8_08.yaml >> ../results/C_8_08.log 
