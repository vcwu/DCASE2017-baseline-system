...
#SBATCH -o ../results/B_00_3.out # output file name, in case your program has anything to output (like print, etc)
...
python ../applications/task1.py -p ../configs/B_00_3.yaml >> ../results/B_00_3.log 
