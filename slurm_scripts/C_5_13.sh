...
#SBATCH -o ../results/C_5_13.out # output file name, in case your program has anything to output (like print, etc)
...
python ../applications/task1.py  -p ../configs/C_5_13.yaml >> ../results/C_5_13.log 
