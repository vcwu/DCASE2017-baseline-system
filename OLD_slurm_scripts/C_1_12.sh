...
#SBATCH -o ../results/C_1_12.out # output file name, in case your program has anything to output (like print, etc)
...
python ../applications/task1.py -m challenge -p ../configs/C_0_12.yaml >> ../results/C_1_12.log 
