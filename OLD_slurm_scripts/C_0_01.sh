...
#SBATCH -o ../results/C_0_01.out # output file name, in case your program has anything to output (like print, etc)
...
python ../applications/task1.py -p ../configs/C_0_01.yaml >> ../results/C_0_01.log 
