...
#SBATCH -o results/A_00_2_gpu2.out # output file name, in case your program has anything to output (like print, etc)
#SBATCH -t 3:00:00 # Amount of time
#SBATCH --gres=gpu:2 # No. of GPU cores you wanna use. Usually 2-3

source activate dlnn_gpu 
python applications/task1.py -p configs/A_00_2.yaml >> A_00_2_gpu2.log 
