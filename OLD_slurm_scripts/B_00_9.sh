...
#SBATCH -o results/B_00_9.out # output file name, in case your program has anything to output (like print, etc)
...
python applications/task1.py -p configs/B_00_9.yaml >> results/B_00_9.log 
